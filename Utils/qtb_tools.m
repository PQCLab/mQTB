...
function [data, meas, time_proto, sm_flag] = simulate_experiment(dm, ntot, fun_proto, fun_meas, dim)
    data = {};
    meas = {};
    time_proto = 0;
    sm_flag = true;
    ...
    while jn < ntot
        ...
        sm_flag = sm_flag && all(qtb_tools.isprod(meas_curr.elem, dim));
        data{end+1} = qtb_tools.call(fun_meas, dm, meas_curr);
